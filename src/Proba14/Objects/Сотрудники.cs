...
namespace IIS.Proba14
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba14.ДолжнСотр fДолжнСотр;
        ...
        [PropertyStorage(new string[] {
                "ДолжнСотр"})]
        [NotNull()]
        public virtual IIS.Proba14.ДолжнСотр ДолжнСотр
        {
            get
            {
                ...
                IIS.Proba14.ДолжнСотр result = this.fДолжнСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Proba14.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Proba14.Сотрудники));
                }
            }
        }
    }
