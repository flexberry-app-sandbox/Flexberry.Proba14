...
namespace IIS.Proba14
{
    ...
    [View("ПланирСобесE", new string[] {
            ...
            "РегистАнкеты.ФИОКандидата as \'ФИО кандидата\'",
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba14.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba14.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba14.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba14.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba14.ПланирСобес));
                }
            }
        }
    }
