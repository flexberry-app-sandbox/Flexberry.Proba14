...
namespace IIS.Proba14
{
    ...
    [View("РегРезультE", new string[] {
            ...
            "Сотрудники as \'Имена и должности участников собеседования\'",
            "Сотрудники.ФИОСотруд as \'Ф и о сотруд\'",
            "Сотрудники.ДолжнСотр.Должность as \'Должность сотрудника\'",
    ...
    [View("РегРезультL", new string[] {
            ...
            "Сотрудники.ФИОСотруд as \'Имена и должности участников собеседования\'",
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba14.ПланирСобес fПланирСобес;
        
        private IIS.Proba14.Сотрудники fСотрудники;
        
        private IIS.Proba14.Организация fОрганизация;
        
        private IIS.Proba14.DetailArrayOfТЧРегРезульт fТЧРегРезульт;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proba14.Организация Организация
        {
            get
            {
                ...
                IIS.Proba14.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "ПланирСобес"})]
        [NotNull()]
        public virtual IIS.Proba14.ПланирСобес ПланирСобес
        {
            get
            {
                ...
                IIS.Proba14.ПланирСобес result = this.fПланирСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba14.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba14.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.Proba14.DetailArrayOfТЧРегРезульт ТЧРегРезульт
        {
            get
            {
                ...
                {
                    this.fТЧРегРезульт = new IIS.Proba14.DetailArrayOfТЧРегРезульт(this);
                }
                IIS.Proba14.DetailArrayOfТЧРегРезульт result = this.fТЧРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba14.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba14.РегРезульт));
                }
            }
        }
    }
